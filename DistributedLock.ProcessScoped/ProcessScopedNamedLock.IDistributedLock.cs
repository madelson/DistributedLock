...
namespace Medallion.Threading
{
    public partial class ProcessScopedNamedLock
    {
        ...
        /// <returns>A <see cref="ProcessScopedNamedLockHandle"/> which can be used to release the lock or null on failure</returns>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedLockHandle"/> which can be used to release the lock</returns>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedLockHandle"/> which can be used to release the lock or null on failure</returns>
        public ValueTask<ProcessScopedNamedLockHandle?> TryAcquireAsync(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
            this.As<IInternalDistributedLock<ProcessScopedNamedLockHandle>>().InternalTryAcquireAsync(timeout, cancellationToken);
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedLockHandle"/> which can be used to release the lock</returns>
        public ValueTask<ProcessScopedNamedLockHandle> AcquireAsync(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
