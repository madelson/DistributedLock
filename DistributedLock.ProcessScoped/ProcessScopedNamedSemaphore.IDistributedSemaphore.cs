...
namespace Medallion.Threading
{
    public partial class ProcessScopedNamedSemaphore
    {
        ...
        /// <returns>A <see cref="ProcessScopedNamedSemaphoreHandle"/> which can be used to release the ticket or null on failure</returns>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedSemaphoreHandle"/> which can be used to release the ticket</returns>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedSemaphoreHandle"/> which can be used to release the ticket or null on failure</returns>
        public ValueTask<ProcessScopedNamedSemaphoreHandle?> TryAcquireAsync(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
            this.As<IInternalDistributedSemaphore<ProcessScopedNamedSemaphoreHandle>>().InternalTryAcquireAsync(timeout, cancellationToken);
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="ProcessScopedNamedSemaphoreHandle"/> which can be used to release the ticket</returns>
        public ValueTask<ProcessScopedNamedSemaphoreHandle> AcquireAsync(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
