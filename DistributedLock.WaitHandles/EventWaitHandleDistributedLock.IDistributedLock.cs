...
{
    public partial class EventWaitHandleDistributedLock
    {
        // AUTO-GENERATED
        ...
        /// <returns>An <see cref="EventWaitHandleDistributedLockHandle"/> which can be used to release the lock, or null if the lock was not taken</returns>
        public EventWaitHandleDistributedLockHandle? TryAcquire(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>An <see cref="EventWaitHandleDistributedLockHandle"/> which can be used to release the lock</returns>
        public EventWaitHandleDistributedLockHandle Acquire(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>An <see cref="EventWaitHandleDistributedLockHandle"/> which can be used to release the lock, or null if the lock was not taken</returns>
        public ValueTask<EventWaitHandleDistributedLockHandle?> TryAcquireAsync(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
            this.As<IInternalDistributedLock<EventWaitHandleDistributedLockHandle>>().InternalTryAcquireAsync(timeout, cancellationToken);
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>An <see cref="EventWaitHandleDistributedLockHandle"/> which can be used to release the lock</returns>
        public ValueTask<EventWaitHandleDistributedLockHandle> AcquireAsync(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
