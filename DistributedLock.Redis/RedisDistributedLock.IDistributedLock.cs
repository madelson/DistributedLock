...
public partial class RedisDistributedLock
{
    ...
    /// <returns>A <see cref="RedisDistributedLockHandle"/> which can be used to release the lock or null on failure</returns>
    ...
    /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
    /// <returns>A <see cref="RedisDistributedLockHandle"/> which can be used to release the lock</returns>
