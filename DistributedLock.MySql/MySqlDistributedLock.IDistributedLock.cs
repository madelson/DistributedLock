...
{
    public partial class MySqlDistributedLock
    {
        // AUTO-GENERATED
        ...
        /// <returns>A <see cref="MySqlDistributedLockHandle"/> which can be used to release the lock or null on failure</returns>
        public MySqlDistributedLockHandle? TryAcquire(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="MySqlDistributedLockHandle"/> which can be used to release the lock</returns>
        public MySqlDistributedLockHandle Acquire(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="MySqlDistributedLockHandle"/> which can be used to release the lock or null on failure</returns>
        public ValueTask<MySqlDistributedLockHandle?> TryAcquireAsync(TimeSpan timeout = default, CancellationToken cancellationToken = default) =>
            this.As<IInternalDistributedLock<MySqlDistributedLockHandle>>().InternalTryAcquireAsync(timeout, cancellationToken);
        ...
        /// <param name="cancellationToken">Specifies a token by which the wait can be canceled</param>
        /// <returns>A <see cref="MySqlDistributedLockHandle"/> which can be used to release the lock</returns>
        public ValueTask<MySqlDistributedLockHandle> AcquireAsync(TimeSpan? timeout = null, CancellationToken cancellationToken = default) =>
