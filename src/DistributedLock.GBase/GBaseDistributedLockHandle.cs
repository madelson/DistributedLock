...
/// </summary>
public sealed class GBaseDistributedLockHandle : IDistributedSynchronizationHandle
{
    private IDistributedSynchronizationHandle? _innerHandle;

    internal GBaseDistributedLockHandle(IDistributedSynchronizationHandle innerHandle)
    {
