...
/// <summary>
/// Options for EtcdLocks including renewal, MinLease,MaxLease TODO what to write here 
/// </summary>
public class EtcdLeaseOptionsBuilder
{
    ...
    /// </summary>
    private static readonly TimeoutValue MinLeaseDuration = TimeSpan.FromSeconds(15);

    /// <summary>
    /// From https://docs.microsoft.com/en-us/rest/api/storageservices/lease-blob:
    /// "The lock duration can be 15 to 60 seconds, or can be infinite"
    /// </summary>
    private static readonly TimeoutValue MaxNonInfiniteLeaseDuration = TimeSpan.FromSeconds(60);

    /// <summary>
    /// From https://docs.microsoft.com/en-us/rest/api/storageservices/lease-blob:
    /// "The lock duration can be 15 to 60 seconds, or can be infinite"
    /// </summary>
    private static readonly TimeoutValue DefaultLeaseDuration = TimeSpan.FromSeconds(30);
