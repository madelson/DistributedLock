...
### [Medallion.Threading.ZooKeeper](Medallion.Threading.ZooKeeper.md 'Medallion.Threading.ZooKeeper').[ZooKeeperDistributedLockHandle](ZooKeeperDistributedLockHandle.md 'Medallion.Threading.ZooKeeper.ZooKeeperDistributedLockHandle')

## ZooKeeperDistributedLockHandle.HandleLostToken Property
