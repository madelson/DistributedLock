...
## RedisDistributedReaderWriterLock.AcquireWriteLockAsync(Nullable<TimeSpan>, CancellationToken) Method
...
```csharp
public System.Threading.Tasks.ValueTask<Medallion.Threading.Redis.RedisDistributedReaderWriterLockHandle> AcquireWriteLockAsync(System.Nullable<System.TimeSpan> timeout=null, System.Threading.CancellationToken cancellationToken=default(System.Threading.CancellationToken));
```
#### Parameters

<a name='Medallion.Threading.Redis.RedisDistributedReaderWriterLock.AcquireWriteLockAsync(System.Nullable_System.TimeSpan_,System.Threading.CancellationToken).timeout'></a>
...
<a name='Medallion.Threading.Redis.RedisDistributedReaderWriterLock.AcquireWriteLockAsync(System.Nullable_System.TimeSpan_,System.Threading.CancellationToken).cancellationToken'></a>
