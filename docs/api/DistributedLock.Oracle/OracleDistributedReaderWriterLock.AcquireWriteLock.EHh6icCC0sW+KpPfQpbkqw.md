...
## OracleDistributedReaderWriterLock.AcquireWriteLock(Nullable<TimeSpan>, CancellationToken) Method
...
```csharp
public Medallion.Threading.Oracle.OracleDistributedReaderWriterLockHandle AcquireWriteLock(System.Nullable<System.TimeSpan> timeout=null, System.Threading.CancellationToken cancellationToken=default(System.Threading.CancellationToken));
```
#### Parameters

<a name='Medallion.Threading.Oracle.OracleDistributedReaderWriterLock.AcquireWriteLock(System.Nullable_System.TimeSpan_,System.Threading.CancellationToken).timeout'></a>
...
<a name='Medallion.Threading.Oracle.OracleDistributedReaderWriterLock.AcquireWriteLock(System.Nullable_System.TimeSpan_,System.Threading.CancellationToken).cancellationToken'></a>
